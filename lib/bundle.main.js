    ...
    },
    {
      ...
      value: function toSerializable() {
        ...
        var omitList = [
          ...
          'updateQueue',
          'ref',
          'elementType', // "stateNode", // serialization needed for this?
...
function getElementName(fiber) {
  switch (fiber.tag) {
    ...
    case 5:
      return ''.concat(fiber.elementType).concat(fiber.elementType.className ? '.'.concat(fiber.elementType.className) : '');
  ...
  createClass(Tree, [
    {
      ...
      value: function processNode(fiberNode, previousTreeNode) {
        ...
        var uniquePart = undefined; // unique part of a fiber node depends on its type.
...
export {getAllSlowComponentRenders, getTotalCommitCount, mountToReactRoot, report};
